...
public class Configuration {
	...
	public static class Paths {
		...
		public static class URLs {
			public static final String New_Host = "http://ultimate-bots.webs.com/";
			public static final String New_Version_File = New_Host + "version.txt";
			...
			public static final String AD_INFO = New_Host + "ads.txt";
		...
		public static Map<String, File> getCachableResources() {
			if (cachableResources == null) {
				...
				cachableResources.put(URLs.New_Version_File, new File(getCacheDirectory(), "version-latest.txt"));
	...
	public static final String NAME = "UBot";
	public static final String NAME_LOWERCASE = NAME.toLowerCase();
	private static final OperatingSystem CURRENT_OS;
	public static boolean RUNNING_FROM_JAR = false;
	public final static boolean SKINNED = true;
	public static final String SKIN = "org.pushingpixels.substance.api.skin.SubstanceTwilightLookAndFeel";
	public static final boolean GOOGLEDNS = true;

	public static class Twitter {
		public static final boolean ENABLED = true;
		public static final String NAME = "ultimatebotorg";
