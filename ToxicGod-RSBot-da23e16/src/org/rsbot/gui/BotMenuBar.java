...
public class BotMenuBar extends JMenuBar {
	...
	static {
		...
		TITLES = new String[]{Messages.FILE, Messages.EDIT, Messages.VIEW, Messages.TOOLS};
		ELEMENTS = new String[][]{
				...
				constructDebugs(), {Messages.OPTIONS}, {Messages.SITE, Messages.PROJECT, Messages.LICENSE, Messages.ABOUT}};
	}
	...
	public void setExtendedView(final boolean show) {
		for (String disableFeature : EXTENDED_VIEW_ITEMS) {
			if (commandCheckMap.containsKey(disableFeature)) {
				...
				commandCheckMap.get(disableFeature).setSelected(true);
			}
		}
	}
